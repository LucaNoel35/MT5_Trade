...
class ConTrader:
    ...
    def performTrade(self):
        ...
        self.execute_trades(1,-1,"price_1","price_2","position_1","position_2",self.loss/self.gain,self.gain/self.gain,self.gain,self.loss,-1,1,-1,-1)
        self.execute_trades(-1,1,"price_2","price_1","position_2","position_1",self.gain,self.loss,self.loss/self.gain,self.gain/self.gain,-1,1,-1,-1)        
